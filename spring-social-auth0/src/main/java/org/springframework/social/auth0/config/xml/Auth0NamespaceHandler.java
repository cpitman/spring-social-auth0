...
/**
 * {@link NamespaceHandler} for Spring Social Auth0
 * 
 * @author Craig Walls
 */
public class Auth0NamespaceHandler extends AbstractProviderConfigNamespaceHandler {

	@Override
	protected AbstractProviderConfigBeanDefinitionParser getProviderConfigBeanDefinitionParser() {
		return new Auth0ConfigBeanDefinitionParser();
	}
